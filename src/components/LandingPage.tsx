...
import { ShoppingBag, Mic, Star, Truck, Shield, Headphones, ArrowRight, ChevronDown, Search, Heart, TrendingUp, Award, ChevronLeft, ChevronRight, Mail, User, Play } from 'lucide-react';
