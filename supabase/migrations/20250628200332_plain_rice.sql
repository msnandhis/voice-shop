...
-- Create policies for new tables (public read access) - Drop and recreate to avoid conflicts
...
DROP POLICY IF EXISTS "Public read access for product_attributes" ON product_attributes;
...
-- Insert brands (use ON CONFLICT to handle existing records)
...
FROM (VALUES
  ...
  ('iPad Pro 12.9"', 'The ultimate iPad experience with the M2 chip, Liquid Retina XDR display, and support for Apple Pencil hover.', 1099.00, 'electronics', 'https://images.pexels.com/photos/1440727/pexels-photo-1440727.jpeg', 16, ARRAY['ipad', 'pro', 'tablet', 'apple', 'm2', 'retina', 'professional', 'display'], 4.7, ARRAY['128GB', '256GB', '512GB', '1TB', '2TB'], ARRAY['Silver', 'Space Gray'], 'Apple'),
  ...
  -- HOME CATEGORY
  ('Dyson V15 Detect', 'The most powerful, intelligent cordless vacuum. Laser reveals microscopic dust. Advanced whole-machine filtration captures 99.99% of particles, dust and allergens as small as 0.3 microns.', 749.99, 'home', 'https://images.pexels.com/photos/4239037/pexels-photo-4239037.jpeg', 12, ARRAY['dyson', 'v15', 'detect', 'vacuum', 'cordless', 'laser', 'cleaning', 'powerful'], 4.6, ARRAY['Standard'], ARRAY['Yellow/Nickel', 'Red/Nickel'], 'Dyson'),
...
-- Insert product images (multiple images per product with relevant images for each product type)
...
CROSS JOIN LATERAL (
  VALUES 
    -- Nike Air Max 270 images (only shoe images)
    ...
    (CASE WHEN p.name = 'Nike Air Max 270' THEN 'https://images.pexels.com/photos/1598507/pexels-photo-1598507.jpeg' END, 'Nike Air Max 270 - Side View', false, 2, 'Black/White'),
    (CASE WHEN p.name = 'Nike Air Max 270' THEN 'https://images.pexels.com/photos/1032110/pexels-photo-1032110.jpeg' END, 'Nike Air Max 270 - Detail View', false, 3, 'Black/White'),
    (CASE WHEN p.name = 'Nike Air Max 270' THEN 'https://images.pexels.com/photos/1464625/pexels-photo-1464625.jpeg' END, 'Nike Air Max 270 - White Variant', false, 4, 'Triple White'),
    
    -- Adidas Ultraboost 22 images (only shoe images)
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'https://images.pexels.com/photos/1598505/pexels-photo-1598505.jpeg' END, 'Adidas Ultraboost 22 - Main View', true, 1, 'Core Black'),
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'https://images.pexels.com/photos/2421374/pexels-photo-2421374.jpeg' END, 'Adidas Ultraboost 22 - Angle View', false, 2, 'Core Black'),
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'https://images.pexels.com/photos/1280064/pexels-photo-1280064.jpeg' END, 'Adidas Ultraboost 22 - Side View', false, 3, 'Core Black'),
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'https://images.pexels.com/photos/1240892/pexels-photo-1240892.jpeg' END, 'Adidas Ultraboost 22 - Cloud White', false, 4, 'Cloud White'),
    
    -- Vans Old Skool images (only skateboard shoe images)
    (CASE WHEN p.name = 'Vans Old Skool' THEN 'https://images.pexels.com/photos/1464625/pexels-photo-1464625.jpeg' END, 'Vans Old Skool - Main View', true, 1, 'Black/White'),
    (CASE WHEN p.name = 'Vans Old Skool' THEN 'https://images.pexels.com/photos/1240892/pexels-photo-1240892.jpeg' END, 'Vans Old Skool - Side View', false, 2, 'Black/White'),
    (CASE WHEN p.name = 'Vans Old Skool' THEN 'https://images.pexels.com/photos/1230679/pexels-photo-1230679.jpeg' END, 'Vans Old Skool - Top View', false, 3, 'Black/White'),
    (CASE WHEN p.name = 'Vans Old Skool' THEN 'https://images.pexels.com/photos/2529148/pexels-photo-2529148.jpeg' END, 'Vans Old Skool - True White', false, 4, 'True White'),
    
    -- Converse Chuck Taylor images (only sneaker images)
    (CASE WHEN p.name = 'Converse Chuck Taylor All Star' THEN 'https://images.pexels.com/photos/1032110/pexels-photo-1032110.jpeg' END, 'Converse Chuck Taylor - Main View', true, 1, 'Black'),
    (CASE WHEN p.name = 'Converse Chuck Taylor All Star' THEN 'https://images.pexels.com/photos/1280064/pexels-photo-1280064.jpeg' END, 'Converse Chuck Taylor - Top View', false, 2, 'Black'),
    (CASE WHEN p.name = 'Converse Chuck Taylor All Star' THEN 'https://images.pexels.com/photos/1598505/pexels-photo-1598505.jpeg' END, 'Converse Chuck Taylor - Side View', false, 3, 'Black'),
    (CASE WHEN p.name = 'Converse Chuck Taylor All Star' THEN 'https://images.pexels.com/photos/1598507/pexels-photo-1598507.jpeg' END, 'Converse Chuck Taylor - White', false, 4, 'White'),
    
    -- iPhone 15 Pro images (only smartphone images)
    ...
    (CASE WHEN p.name = 'iPhone 15 Pro' THEN 'https://images.pexels.com/photos/47261/pexels-photo-47261.jpeg' END, 'iPhone 15 Pro - Back View', false, 2, 'Natural Titanium'),
    (CASE WHEN p.name = 'iPhone 15 Pro' THEN 'https://images.pexels.com/photos/193004/pexels-photo-193004.jpeg' END, 'iPhone 15 Pro - Profile View', false, 3, 'Natural Titanium'),
    (CASE WHEN p.name = 'iPhone 15 Pro' THEN 'https://images.pexels.com/photos/1042143/pexels-photo-1042143.jpeg' END, 'iPhone 15 Pro - Blue Titanium', false, 4, 'Blue Titanium'),
    
    -- Samsung Galaxy S24 Ultra images (only smartphone images)
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'https://images.pexels.com/photos/1440727/pexels-photo-1440727.jpeg' END, 'Samsung Galaxy S24 Ultra - Front View', true, 1, 'Titanium Black'),
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'https://images.pexels.com/photos/404280/pexels-photo-404280.jpeg' END, 'Samsung Galaxy S24 Ultra - Back View', false, 2, 'Titanium Black'),
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'https://images.pexels.com/photos/1092671/pexels-photo-1092671.jpeg' END, 'Samsung Galaxy S24 Ultra - Profile View', false, 3, 'Titanium Black'),
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg' END, 'Samsung Galaxy S24 Ultra - Gray Variant', false, 4, 'Titanium Gray'),
    
    -- Sony WH-1000XM5 images (only headphone images)
    ...
    (CASE WHEN p.name = 'Sony WH-1000XM5' THEN 'https://images.pexels.com/photos/3587478/pexels-photo-3587478.jpeg' END, 'Sony WH-1000XM5 - Side View', false, 2, 'Black'),
    (CASE WHEN p.name = 'Sony WH-1000XM5' THEN 'https://images.pexels.com/photos/1649771/pexels-photo-1649771.jpeg' END, 'Sony WH-1000XM5 - Detail View', false, 3, 'Black'),
    (CASE WHEN p.name = 'Sony WH-1000XM5' THEN 'https://images.pexels.com/photos/3780681/pexels-photo-3780681.jpeg' END, 'Sony WH-1000XM5 - Silver Variant', false, 4, 'Silver'),
    
    -- MacBook Air M3 images (only laptop images)
    ...
    (CASE WHEN p.name = 'MacBook Air M3' THEN 'https://images.pexels.com/photos/459653/pexels-photo-459653.jpeg' END, 'MacBook Air M3 - Side View', false, 2, 'Silver'),
    (CASE WHEN p.name = 'MacBook Air M3' THEN 'https://images.pexels.com/photos/812264/pexels-photo-812264.jpeg' END, 'MacBook Air M3 - Open View', false, 3, 'Silver'),
    (CASE WHEN p.name = 'MacBook Air M3' THEN 'https://images.pexels.com/photos/7974/pexels-photo.jpg' END, 'MacBook Air M3 - Space Gray', false, 4, 'Space Gray'),
    
    -- iPad Pro images (only tablet images)
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'https://images.pexels.com/photos/1334597/pexels-photo-1334597.jpeg' END, 'iPad Pro - Main View', true, 1, 'Silver'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'https://images.pexels.com/photos/1716533/pexels-photo-1716533.jpeg' END, 'iPad Pro - Using Pencil', false, 2, 'Silver'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'https://images.pexels.com/photos/1841841/pexels-photo-1841841.jpeg' END, 'iPad Pro - Side View', false, 3, 'Silver'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'https://images.pexels.com/photos/3780681/pexels-photo-3780681.jpeg' END, 'iPad Pro - Space Gray', false, 4, 'Space Gray'),
    
    -- Levi's 501 images (only jeans/clothing images)
    ...
    (CASE WHEN p.name = 'Levi''s 501 Original Jeans' THEN 'https://images.pexels.com/photos/1598507/pexels-photo-1598507.jpeg' END, 'Levi''s 501 - Detail View', false, 2, 'Dark Stonewash'),
    (CASE WHEN p.name = 'Levi''s 501 Original Jeans' THEN 'https://images.pexels.com/photos/934070/pexels-photo-934070.jpeg' END, 'Levi''s 501 - Fit View', false, 3, 'Dark Stonewash'),
    (CASE WHEN p.name = 'Levi''s 501 Original Jeans' THEN 'https://images.pexels.com/photos/8532616/pexels-photo-8532616.jpeg' END, 'Levi''s 501 - Medium Stonewash', false, 4, 'Medium Stonewash'),
    
    -- Patagonia Better Sweater images (only clothing images)
    ...
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'https://images.pexels.com/photos/5212320/pexels-photo-5212320.jpeg' END, 'Patagonia Better Sweater - Side View', false, 2, 'Navy Blue'),
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'https://images.pexels.com/photos/8532617/pexels-photo-8532617.jpeg' END, 'Patagonia Better Sweater - Black', false, 3, 'Black'),
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'https://images.pexels.com/photos/9594675/pexels-photo-9594675.jpeg' END, 'Patagonia Better Sweater - Fit View', false, 4, 'Oatmeal Heather'),
    
    -- Nike Dri-FIT T-Shirt images (only athletic wear images)
    (CASE WHEN p.name = 'Nike Dri-FIT T-Shirt' THEN 'https://images.pexels.com/photos/8532616/pexels-photo-8532616.jpeg' END, 'Nike Dri-FIT T-Shirt - Main View', true, 1, 'Black'),
    (CASE WHEN p.name = 'Nike Dri-FIT T-Shirt' THEN 'https://images.pexels.com/photos/7207788/pexels-photo-7207788.jpeg' END, 'Nike Dri-FIT T-Shirt - Side View', false, 2, 'Black'),
    (CASE WHEN p.name = 'Nike Dri-FIT T-Shirt' THEN 'https://images.pexels.com/photos/6311449/pexels-photo-6311449.jpeg' END, 'Nike Dri-FIT T-Shirt - White', false, 3, 'White'),
    (CASE WHEN p.name = 'Nike Dri-FIT T-Shirt' THEN 'https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg' END, 'Nike Dri-FIT T-Shirt - Gray', false, 4, 'Grey'),
    
    -- Dyson V15 Detect images (only vacuum images)
    ...
    (CASE WHEN p.name = 'Dyson V15 Detect' THEN 'https://images.pexels.com/photos/4108715/pexels-photo-4108715.jpeg' END, 'Dyson V15 Detect - In Use', false, 2, 'Yellow/Nickel'),
    (CASE WHEN p.name = 'Dyson V15 Detect' THEN 'https://images.pexels.com/photos/4108807/pexels-photo-4108807.jpeg' END, 'Dyson V15 Detect - Attachment', false, 3, 'Yellow/Nickel'),
    (CASE WHEN p.name = 'Dyson V15 Detect' THEN 'https://images.pexels.com/photos/6045321/pexels-photo-6045321.jpeg' END, 'Dyson V15 Detect - Red Variant', false, 4, 'Red/Nickel'),
    
    -- IKEA Kallax images (only furniture images)
    (CASE WHEN p.name = 'IKEA Kallax Shelf Unit' THEN 'https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg' END, 'IKEA Kallax Shelf Unit - Main View', true, 1, 'White'),
    (CASE WHEN p.name = 'IKEA Kallax Shelf Unit' THEN 'https://images.pexels.com/photos/2082090/pexels-photo-2082090.jpeg' END, 'IKEA Kallax Shelf Unit - In Room', false, 2, 'White'),
    (CASE WHEN p.name = 'IKEA Kallax Shelf Unit' THEN 'https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg' END, 'IKEA Kallax Shelf Unit - With Items', false, 3, 'White'),
    (CASE WHEN p.name = 'IKEA Kallax Shelf Unit' THEN 'https://images.pexels.com/photos/276534/pexels-photo-276534.jpeg' END, 'IKEA Kallax Shelf Unit - Black-Brown', false, 4, 'Black-Brown'),
    
    -- Yeti Rambler images (only water bottle images)
    (CASE WHEN p.name = 'Yeti Rambler 32oz' THEN 'https://images.pexels.com/photos/1198802/pexels-photo-1198802.jpeg' END, 'Yeti Rambler 32oz - Main View', true, 1, 'Black'),
    (CASE WHEN p.name = 'Yeti Rambler 32oz' THEN 'https://images.pexels.com/photos/3334355/pexels-photo-3334355.jpeg' END, 'Yeti Rambler 32oz - Various Sizes', false, 2, 'Black'),
    (CASE WHEN p.name = 'Yeti Rambler 32oz' THEN 'https://images.pexels.com/photos/6621496/pexels-photo-6621496.jpeg' END, 'Yeti Rambler 32oz - Outdoor Use', false, 3, 'Black'),
    (CASE WHEN p.name = 'Yeti Rambler 32oz' THEN 'https://images.pexels.com/photos/4239037/pexels-photo-4239037.jpeg' END, 'Yeti Rambler 32oz - White', false, 4, 'White'),
    
    -- Nike Pro Training Set images (only athletic wear images)
    (CASE WHEN p.name = 'Nike Pro Training Set' THEN 'https://images.pexels.com/photos/4056535/pexels-photo-4056535.jpeg' END, 'Nike Pro Training Set - Main View', true, 1, 'Black'),
    (CASE WHEN p.name = 'Nike Pro Training Set' THEN 'https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg' END, 'Nike Pro Training Set - Close-up', false, 2, 'Black'),
    (CASE WHEN p.name = 'Nike Pro Training Set' THEN 'https://images.pexels.com/photos/8532616/pexels-photo-8532616.jpeg' END, 'Nike Pro Training Set - In Use', false, 3, 'Black'),
    (CASE WHEN p.name = 'Nike Pro Training Set' THEN 'https://images.pexels.com/photos/6311449/pexels-photo-6311449.jpeg' END, 'Nike Pro Training Set - Navy', false, 4, 'Navy')
...
CROSS JOIN LATERAL (
  VALUES 
    ...
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'ADIDAS-UB22-BLK-8' END, 'Core Black', '8', 'Primeknit/Rubber', 180.00, 14, 370, '{"length": 29, "width": 11, "height": 12}'::jsonb),
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'ADIDAS-UB22-BLK-9' END, 'Core Black', '9', 'Primeknit/Rubber', 180.00, 10, 380, '{"length": 30, "width": 11, "height": 12}'::jsonb),
    (CASE WHEN p.name = 'Adidas Ultraboost 22' THEN 'ADIDAS-UB22-WHT-8' END, 'Cloud White', '8', 'Primeknit/Rubber', 180.00, 8, 370, '{"length": 29, "width": 11, "height": 12}'::jsonb),
    ...
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'SAMS-S24U-BLK-256' END, 'Titanium Black', '256GB', 'Titanium/Glass', 1199.00, 6, 233, '{"length": 162.3, "width": 79.0, "height": 8.6}'::jsonb),
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'SAMS-S24U-GRY-256' END, 'Titanium Gray', '256GB', 'Titanium/Glass', 1199.00, 4, 233, '{"length": 162.3, "width": 79.0, "height": 8.6}'::jsonb),
    (CASE WHEN p.name = 'Samsung Galaxy S24 Ultra' THEN 'SAMS-S24U-BLK-512' END, 'Titanium Black', '512GB', 'Titanium/Glass', 1299.00, 3, 233, '{"length": 162.3, "width": 79.0, "height": 8.6}'::jsonb),
    
    -- Sony WH-1000XM5 variants
    (CASE WHEN p.name = 'Sony WH-1000XM5' THEN 'SONY-WH1000XM5-BLK' END, 'Black', 'One Size', 'Plastic/Foam', 399.99, 15, 250, '{"length": 254, "width": 203, "height": 76}'::jsonb),
    (CASE WHEN p.name = 'Sony WH-1000XM5' THEN 'SONY-WH1000XM5-SLV' END, 'Silver', 'One Size', 'Plastic/Foam', 399.99, 10, 250, '{"length": 254, "width": 203, "height": 76}'::jsonb),
    ...
    -- iPad Pro variants
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'IPADPRO-129-SLV-256' END, 'Silver', '256GB', 'Aluminum/Glass', 1099.00, 6, 682, '{"length": 280.6, "width": 214.9, "height": 6.4}'::jsonb),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'IPADPRO-129-SG-256' END, 'Space Gray', '256GB', 'Aluminum/Glass', 1099.00, 5, 682, '{"length": 280.6, "width": 214.9, "height": 6.4}'::jsonb),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'IPADPRO-129-SLV-512' END, 'Silver', '512GB', 'Aluminum/Glass', 1299.00, 3, 682, '{"length": 280.6, "width": 214.9, "height": 6.4}'::jsonb),
    ...
    -- Patagonia Better Sweater variants
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'PATA-BS-NVY-M' END, 'Navy Blue', 'M', 'Recycled Polyester', 119.00, 12, 540, '{"length": 71, "width": 56, "height": 2}'::jsonb),
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'PATA-BS-NVY-L' END, 'Navy Blue', 'L', 'Recycled Polyester', 119.00, 10, 560, '{"length": 74, "width": 58, "height": 2}'::jsonb),
    (CASE WHEN p.name = 'Patagonia Better Sweater Fleece' THEN 'PATA-BS-BLK-M' END, 'Black', 'M', 'Recycled Polyester', 119.00, 9, 540, '{"length": 71, "width": 56, "height": 2}'::jsonb)
...
CROSS JOIN LATERAL (
  VALUES 
    ...
    -- iPad Pro attributes
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Processor' END, 'Apple M2 chip', 'text'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Display Size' END, '12.9 inches', 'text'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Display Technology' END, 'Liquid Retina XDR', 'text'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Camera' END, '12MP wide, 10MP ultrawide', 'text'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Battery Life' END, 'Up to 10 hours', 'text'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Apple Pencil Support' END, 'Yes (2nd gen)', 'boolean'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Face ID' END, 'Yes', 'boolean'),
    (CASE WHEN p.name = 'iPad Pro 12.9"' THEN 'Connectivity' END, 'Wi-Fi 6E, 5G (optional)', 'text'),
